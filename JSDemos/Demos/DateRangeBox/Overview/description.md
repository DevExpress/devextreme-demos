The [DateRangeBox](/Documentation/ApiReference/UI_Components/dxDateRangeBox/) component allows users to select a date range. The component includes input boxes for start/end dates and an icon for drop-down date picker. This demo shows how you can use the following DateRangeBox settings:
