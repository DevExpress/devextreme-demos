The NumberBox is a component that displays a number. Users can change this number: type a new value or use the spin buttons, keyboard arrows or mouse wheel to increment/decrement it.
