...
function App() {
  ...
  const diffInDay = `${Math.floor(Math.abs(((new Date()).getTime() - value.getTime()) / (24 * 60 * 60 * 1000)))} days`;
    ...
    <div>
      <div className="dx-fieldset">
        ...
        <div className="dx-field">
          ...
          <div className="dx-field-value">
            <DateBox defaultValue={dateClear}
              type="time"
        ...
        <div className="dx-field">
          ...
          <div className="dx-field-value">
            <DateBox defaultValue={firstWorkDay2017}
              type="date"
              pickerType="calendar"
              inputAttr={disabledLabel}
