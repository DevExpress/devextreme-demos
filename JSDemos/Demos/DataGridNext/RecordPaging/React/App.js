...
import DataGrid from '@devextreme/react/data-grid-next';
import Paging from '@devextreme/react/data-grid-next-paging';
import Pager from '@devextreme/react/data-grid-next-pager';
