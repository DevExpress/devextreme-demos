...
function App() {
  ...
  function changeColorPriority(e) {
        ...
        <div className="dx-field">
          ...
          <div className="dx-field-value">
            <RadioGroup
              ...
              items={priorities} value={colorPriority}
              itemRender={renderCustomItem} onValueChanged={changeColorPriority} />
          </div>
        </div>
        <div className="dx-field">
          <div className="dx-field-label">Event handling</div>
          <div className="dx-field-value">
            <RadioGroup id="radio-group-with-selection" items={priorityEntities} value={selectionPriority}
              valueExpr="id" displayExpr="text" onValueChanged={changeSelectionPriority} />
          </div>
        </div>
      </div>
      <div id="tasks-list">
        ...
        <ul id="list">
          {tasks.filter((task) => task.priority === selectionPriority)
