The DevExtreme Navigation components support right-to-left (RTL) languages. The components can display the contents in a right-to-left direction and mirror associated UI elements. 
