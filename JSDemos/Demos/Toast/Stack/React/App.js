...
function App() {
  ...
  return <React.Fragment>
      <div className='options'>
          ...
          <SelectBox items={positions} value={aliasPosition} onSelectionChanged={positionSelectionChanged} visible={isAlias} />
          ...
          <div>direction</div>
          <SelectBox items={directions} value={direction} onSelectionChanged={directionSelectionChanged} />
          <div className='section'>
