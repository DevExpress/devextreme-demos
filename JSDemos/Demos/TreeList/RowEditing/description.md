The TreeList allows users to edit data in multiple modes. This demo shows the *"row"* edit mode. To edit any row, click Edit in it. Only one row can be in the edit state at a time.
