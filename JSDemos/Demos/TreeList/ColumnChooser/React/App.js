...
const App = () => {
  ...
  const handleModeValueChanged = (e) => {
    setMode(e.value);
  };

  const handleSearchEnabledValueChanged = (e) => {
    setSearchEnabled(e.value);
  };

  const handleAllowSelectAllValueChanged = (e) => {
    setAllowSelectAll(e.value);
  };

  const handleSelectByClickValueChanged = (e) => {
    setSelectByClick(e.value);
  };

  const handleRecursiveValueChanged = (e) => {
        ...
        <div className='checkboxes-container'>
          <div className="option">
            <CheckBox
              ...
              text="Search enabled"
              onValueChanged={handleSearchEnabledValueChanged}
            />
          </div>
          <div className="option">
            <CheckBox
              ...
              onValueChanged={handleAllowSelectAllValueChanged}
              disabled={isDragMode}
            />
          </div>
          <div className="option">
            <CheckBox
              ...
              onValueChanged={handleSelectByClickValueChanged}
              disabled={isDragMode}
            />
          </div>
          <div className="option">
            <CheckBox
              ...
              text="Recursive"
              onValueChanged={handleRecursiveValueChanged}
              disabled={isDragMode}
            />
          </div>
        </div>
