...
You can format a summary value in the [valueFormat](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/summary/groupItems/#valueFormat) property. This demo specifies the *"currency"* **valueFormat** for the Total Amount and Sale Amount summary values. You can also use the [displayFormat](/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/summary/groupItems/#displayFormat) property to set a custom display format for summary values. For example, you can add custom text to a summary value, as shown in this demo for summaries of the *"sum"* and *"count"* types.
