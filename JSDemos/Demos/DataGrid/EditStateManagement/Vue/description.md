...
If the server successfully saves changes, call the **applyChanges** method to save the same changes in the component's data source (see the `updateOrders` mutation in `store.js`).
