...
const App = () => {
  ...
  const dataSource = useRef(new DataSource({ store: products }));
  ...
  return (
    <div>
      <div className="filter-container">
        <FilterBuilder ref={setFilterBuilderInstance} fields={fields} value={value} onValueChanged={onValueChanged} />
        <Button text="Apply Filter" type="default" onClick={refreshDataSource} />
