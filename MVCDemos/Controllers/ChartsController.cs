...
namespace DevExtreme.MVC.Demos.Controllers {
    public class ChartsController : Controller {
        ...
        [HttpGet]
        public ActionResult GetWeatherIndicators(DataSourceLoadOptions loadOptions) {
            return Content(JsonConvert.SerializeObject(SampleData.WeatherIndicators), "application/json");
        }
        #endregion
