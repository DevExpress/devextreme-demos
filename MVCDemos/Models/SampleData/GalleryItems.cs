...
namespace DevExtreme.MVC.Demos.Models.SampleData {
    public partial class SampleData {
        public static readonly IEnumerable<GalleryItem> GalleryItems = new[] {
            new GalleryItem {
                ID = 1,
            ...
            new GalleryItem {
                ...
                Type = 0,
                Status = 1,
                Image = "../../Content/Images/Gallery/7.jpg"
            },
            new GalleryItem {
                ID = 8,
                ...
                Type = 0,
                Status = 0,
                Image = "../../Content/Images/Gallery/8.jpg"
            },
            new GalleryItem {
                ID = 9,
                ...
                Type = 0,
                Status = 0,
                Image = "../../Content/Images/Gallery/9.jpg"
            }
        };
    }
}
