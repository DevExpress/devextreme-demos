...
namespace DevExtreme.MVC.Demos.Models.SampleData {
    public partial class SampleData {
        public static readonly IEnumerable<CustomEditorsTask> CustomEditorsTasks = new[] {
            new CustomEditorsTask {
                ID = 1,
                Subject = "Prepare 2013 Financial",
                Status = 5,
                Owner = 1,
                AssignedEmployee = new[] { 7, 1 },
                OrderIndex = 0,
                Priority = 3
            },
            new CustomEditorsTask {
